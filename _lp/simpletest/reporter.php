...
class HtmlReporter extends SimpleReporter {
    ...
    protected function getCss() {
        return "body{ color:#666;font-family:georgia  }
    ...
    function paintFooter($test_name) {
        ...
        print "<div style=\"";
        print "padding: 10px; margin-top: 1em; background-color: $colour; color: white;	-moz-border-radius: 3px;-webkit-border-radius: 3px;border-radius: 3px;box-shadow: 3px 3px 1px #888;opacity:0.8;";
        print "\">";
